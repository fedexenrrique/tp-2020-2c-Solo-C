...
t_config * leer_config(void) {
	...
	if ( config_has_property( config, "PLATOS_DEFAULT"              ) ) g_platos_default              = config_get_string_value(config, "PLATOS_DEFAULT");
	if ( config_has_property( config, "POSICION_REST_DEFAULT_X"     ) ) g_posicion_rest_default_x     = config_get_string_value(config, "POSICION_REST_DEFAULT_X");
	if ( config_has_property( config, "POSICION_REST_DEFAULT_Y"     ) ) g_posicion_rest_default_y     = config_get_string_value(config, "POSICION_REST_DEFAULT_Y");
